...
def _claude_web_news(category: str, avoid: list[str] | None = None) -> dict:
    ...
    user = (
        ...
        f"ATURAN FRESH (WAJIB): target UTAMA = berita TERBIT DALAM 6 JAM TERAKHIR (paling hangat). "
        f"Kalau dalam 6 jam belum ada yang cukup rame/kredibel, boleh sampai maks ~12 jam, "
        ...
        f"(umur jam paling kecil). Mending berita 4 jam yg rame daripada 10 jam yg lebih rame.\n\n"
